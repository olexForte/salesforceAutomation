...
public class RegistrationComponent extends BasePageComponent {
    ...
    public List<Field> setFields(List<Field> fields) {
        List<Field> result = fillDataFields(fields, inputTypes, SHORT_TIMEOUT);
        return result;
    }
    /**
     *
    ...
    public Field setField(Field field) {
        Field result = fillDataField(field, inputTypes, SHORT_TIMEOUT);
        return result;
    }
    /**
     *
    ...
    public List<String> checkFieldLimitWithLessMinSize(List<Field> fields) {
        ...
        for(Field field: fieldsWithMinSizeLimit){
            ...
            if(notValidField.getFieldLabel()=="Billing ZIP*")
                return null;
            setFields(fieldsWithMinSizeLimit);
            setField(notValidField);
            clickSubmit();
